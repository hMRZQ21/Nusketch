    ...
    return
      Scaffold(
        backgroundColor: Colors.white10,
          body: Center(
            // For keyboard opened:
            child: SingleChildScrollView( // its a box that allows a single widget to be scrolled
              physics: BouncingScrollPhysics(), // this allows the content to go outside the bounds of the phone but then bounce back once keyboard is gone
              child: Padding(
